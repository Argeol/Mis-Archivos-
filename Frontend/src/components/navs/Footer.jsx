...
export default function Footer() {
  return (
    <footer className="bg-slate-100 border-t border-gray-200 text-black-800 py-8">
      <div className="container px-4 md:px-6 mx-auto text-center">
        {/* Section 1: About */}
        <div className="space-y-2">
          <h3 className="text-xl font-bold tracking-tight">Bienesoft</h3>
          <p className="text-sm">
            Gestión de permisos para aprendices del centro Agropecuario "La Granja" SENA Espinal-Tolima. 
          </p>
        </div>
